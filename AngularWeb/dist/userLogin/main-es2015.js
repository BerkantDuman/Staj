...
let PeopleService = class PeopleService {
    ...
    getAllPeople() {
        return this.http.get(this.allPeopleUrl)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => this.log('fetched allPeople')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getAllPeople', [])));
    }
    deletePerson(id) {
    ...
    getPerson(id) {
        ...
        return this.http.get(url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => this.log(`fetched person id=${id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError(`getPerson id=${id}`)));
    }
    getPersonWithProduct(id) {
...
let PriceComponent = class PriceComponent {
    ...
    addPerson(firstName, lastName, street, city, state, zip, product_id = this.product_id) {
        const newPerson = { firstName, lastName, street, state, city, zip, product_id };
        this.peopleService
            .addPerson(newPerson)
